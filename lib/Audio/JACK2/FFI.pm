...
use constant $enum_JackOptions;
use constant $enum_JackStatus;
use constant $enum_JackLatencyCallbackMode;
use constant $defines;
...
our @EXPORT = (
    ...
    keys %{ $enum_JackStatus },
    keys %{ $enum_JackLatencyCallbackMode },
    keys %{ $defines },
    keys %{ $binds },
);
